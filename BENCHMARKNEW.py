...
def run_benchmark_suite():
    # Configuration
    sizes = [2, 10, 50, 250, 750, 1000, 2000, 5000, 10000, 100000, 1000000]  # Sizes of N to test
    fixed_density = 2        # Sparsity m/n
    ...
    for n in sizes:
        ...
        matrix = generate_optimized_graph(n, avg_degree=fixed_density, max_weight=20)
